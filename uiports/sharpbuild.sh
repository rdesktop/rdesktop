...
cc="/opt/Embedix/tools/bin/arm-linux-g++"
#cc="g++"
cflags="-I/opt/Qtopia/include -pipe -DQT_QWS_EBX -DQT_QWS_CUSTOM -DQWS -fno-exceptions -fno-rtti -Wall -Os -fno-default-inline -DNO_DEBUG -DSHARP"
# uncomment the following line to turn on debug
#cflags=$cflags+" -DWITH_DEBUG"
lflags="-L/opt/Qtopia/sharp/lib -lqpe -lqte -lcrypto"
...
# qt files
$cc $cflags -I/opt/Qtopia/include -c qtewin.cpp -o qtewin.o

# moc stuff
/opt/Qtopia/bin/moc qtewin.h > moc_qtewin.cpp

$cc $cflags -c moc_qtewin.cpp -o moc_qtewin.o
